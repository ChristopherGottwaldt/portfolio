...
return (
    ...
    <div>
      ...
      <br />
      <br />
      <p>I made this website with Next.js, React, ShadCN, Typescript, and soon-to-be MDX and Tailwind.</p>
      <p className="text-align: center">Here&apos;s where you can see my code:</p>
        <Link href="https://github.com/ChristopherGottwaldt/portfolio" className="text-blue-500 underline hover:text-blue-700">Portfolio Site GitHub</Link> 
    </div>
